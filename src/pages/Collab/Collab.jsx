...
function Collab() {
    ...
    return (
        <>
            <SeoMetaTags
                title="DTF Promo Сотрудничество"
                description="Сотрудничество с дизайнерами и поставка оборудования"
                keywords="сделать принт на футболке, принта на футболке, принт печать на футболках, принт на футболке на заказ, нанести принт на футболку, принт на футболку в москве, печать принта на футболке, напечатать принт на футболке, принт на футболку спб, нанесение на футболку принт, нанесение принта на футболку, сколько стоит принт на футболку, принт печать на одежде, заказать принт на футболку"
                image="/images/collab-og.jpg"
                url="/collab"
            />
